...
function fnafgmMenu()
	...
	if !IsValid(fnafgmMenuF) and !engine.IsPlayingDemo() then
		...
		fnafgmMenuF:SetTitle((GAMEMODE.Name or "?") .. " Gamemode " .. (GAMEMODE.Version or "?") .. (GAMEMODE.Vars.modetext or "") .. (GAMEMODE.Vars.seasonaltext or ""))
		...
		configlbl:SetText(GAMEMODE.TranslatedStrings.config or GAMEMODE.Strings.en.config)
		...
		hideversion:SetText(GAMEMODE.TranslatedStrings.hidever or GAMEMODE.Strings.en.hidever)
		...
		autofnafview:SetText(GAMEMODE.TranslatedStrings.autofnafview or GAMEMODE.Strings.en.autofnafview)
		...
		hud:SetText(GAMEMODE.TranslatedStrings.dhud or GAMEMODE.Strings.en.dhud)
		hud:SetPos(15, 90)
		hud:SetDark(1)
		...
		chatsound:SetText(GAMEMODE.TranslatedStrings.chatsound or GAMEMODE.Strings.en.chatsound)
		...
		saveserver:SetText(GAMEMODE.TranslatedStrings.saveserver or GAMEMODE.Strings.en.saveserver)
		...
		disablehalo:SetText(GAMEMODE.TranslatedStrings.disablehalo or GAMEMODE.Strings.en.disablehalo)
		...
		infolbl:SetText(GAMEMODE.TranslatedStrings.infoat or GAMEMODE.Strings.en.infoat)
		infolbl:SetPos(10, 5)
		infolbl:SetDark(1)
		...
		langinfo:SetText((GAMEMODE.TranslatedStrings.lang or GAMEMODE.Strings.en.lang) .. ": " .. GetConVarString("gmod_language"))
		...
		progressinfo:SetText((GAMEMODE.TranslatedStrings.progressinfo or GAMEMODE.Strings.en.progressinfo) .. ": " .. (nightp or "?"))
		...
		mapselectb:SetText(GAMEMODE.TranslatedStrings.changemap or GAMEMODE.Strings.en.changemap)
		...
		secretb:SetText(GAMEMODE.TranslatedStrings.password or GAMEMODE.Strings.en.password)
		...
		resetprogress:SetText(GAMEMODE.TranslatedStrings.resetsave or GAMEMODE.Strings.en.resetsave)
		...
		debugmenulbl:SetText(GAMEMODE.TranslatedStrings.debugmenu or GAMEMODE.Strings.en.debugmenu)
		...
		startbtn:SetText(GAMEMODE.TranslatedStrings.start or GAMEMODE.Strings.en.start)
		...
		restartbtn:SetText(GAMEMODE.TranslatedStrings.stop or GAMEMODE.Strings.en.stop)
		...
		resetbtn:SetText(GAMEMODE.TranslatedStrings.reset or GAMEMODE.Strings.en.reset)
		...
		refreshbtn:SetText(GAMEMODE.TranslatedStrings.refreshbypass or GAMEMODE.Strings.en.refreshbypass)
