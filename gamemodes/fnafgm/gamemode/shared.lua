...
GM.OfficialVersion 	= "SuperDean-124864f"					--This value shouldn't be touched in derived gamemodes.
...
GM.Strings = {
	en = {
		...
		disablexpsc = "Disable Xperidia's Showcase",
	...
	fr = {
		...
		disablexpsc = "Désactiver Xperidia's Showcase",
	...
	ru = { --Translation by https://steamcommunity.com/profiles/76561198135819236 and https://steamcommunity.com/profiles/76561198146926505
		...
		progressinfo = "Последняя сохраненная ночь",
		disablexpsc = "Отключить витрину Xperidia",
		disablehalo = "Отключить ореолы (Повышает производительность)",
		nightwillstart = "Ночь начнется через",
		togglesgvsa = "Переключить ОпА",
		now_sgvsa = "Игра находится в режиме ПвП ОпА!",
		now_normal = "Игра находится в нормальном режиме!",
		nosp = "Не в одиночке!",
		nosg = "Нет охранников!",
		gamebeenreset = "Игра была сброшена!",
		notsgvsa = "Ты не в режиме ОпА!",
